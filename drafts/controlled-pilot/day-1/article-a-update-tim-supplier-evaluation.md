---
title: "DRAFT UPDATE — How Should Engineers Evaluate Thermal Interface Material Suppliers?"
...
pilot_day: 1
action: UPDATE
target_url: /china-thermal-interface-material-supplier/
primary_keyword: thermal interface material suppliers
search_demand: Unknown
---

> Review draft only. If approved, use this material to strengthen the existing URL. Do not publish it as a second supplier page.
...
- [Why Can the Same Thermal Material Produce Different Test Results?]({{ '/testing/why-can-the-same-thermal-material-produce-different-test-results/' | relative_url }})
