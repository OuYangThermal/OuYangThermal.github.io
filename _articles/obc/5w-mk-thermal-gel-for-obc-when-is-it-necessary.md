---
title: "5W/mK Thermal Gel for OBC: When Is It Necessary?"
description: "A nominal 5 W/m·K gel is justified only when modeling or testing shows lower-conductivity options cannot meet temperature targets at the required gap."
category: "OBC & EV"
category_slug: "obc"
category_url: "/obc/"
...
<div class="quick"><strong>Quick answer</strong><p>Choose the lowest-risk material that meets the temperature limit; conductivity is only one term in the path.</p></div>
...
Bulk resistance scales approximately with thickness divided by conductivity and area. Contact, voids, spreading, and cooling add other resistances.
...
Compare candidates at identical installed gap, power, coolant, mounting, and aging conditions.
