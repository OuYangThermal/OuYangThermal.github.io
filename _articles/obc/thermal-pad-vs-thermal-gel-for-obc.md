---
title: "Thermal Pad vs Thermal Gel for OBC"
description: "Use a pad for clean repeatable placement and controlled compression; use gel for complex geometry, variable gaps, low assembly stress, and automated dispensing."
category: "OBC & EV"
category_slug: "obc"
category_url: "/obc/"
...
<div class="quick"><strong>Quick answer</strong><p>The better OBC interface depends on geometry and production—not a universal family ranking.</p></div>
...
Pads need controlled compression. Gels wet surfaces with lower force but require dispense control and sometimes cure control.
...
A pad may suit a flat controller-to-cover gap, while gel may suit an uneven bank of inductors.
