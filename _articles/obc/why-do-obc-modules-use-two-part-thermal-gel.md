---
title: "Why Do OBC Modules Use Two-Part Thermal Gel?"
description: "Two-part gel is useful when a cured-in-place, compliant material must fill variable gaps and resist flow after dispensing."
category: "OBC & EV"
category_slug: "obc"
category_url: "/obc/"
...
<div class="quick"><strong>Quick answer</strong><p>It combines automated wet dispensing with post-cure dimensional stability; mix ratio and cure control are essential.</p></div>
...
The components react after mixing. Before cure the material wets and fills geometry; after cure it remains softer than a structural adhesive.
...
Between OBC magnetics and a cast housing, gel can bridge nonuniform gaps without the placement force of a thick pad.
