---
title: "Thermal Interface Materials for OBC: Complete Selection Guide"
description: "Select OBC TIMs by heat path, gap tolerance, electrical isolation, mechanical stress, process, and lifetime—not conductivity alone."
category: "OBC & EV"
category_slug: "obc"
category_url: "/obc/"
...
<div class="quick"><strong>Quick answer</strong><p>Map each heat source to its cooling surface; use thin interfaces for flat clamped devices and compliant gap fillers for tolerance-heavy assemblies.</p></div>
...
An OBC contains semiconductors, magnetics, capacitors, control electronics, and a cooling enclosure. Each creates a different heat path and mechanical condition.
...
A typical architecture may use a thin interface or insulator under power devices, a compliant pad or gel over magnetics, and localized potting where environmental protection is justified.
