---
title: "Why Does an OBC Use Multiple Thermal Interface Materials?"
description: "An OBC uses several TIMs because its heat sources, gaps, electrical potentials, surface geometries, and service requirements differ."
category: "OBC & EV"
category_slug: "obc"
category_url: "/obc/"
...
<div class="quick"><strong>Quick answer</strong><p>No single TIM family optimizes every OBC heat path.</p></div>
...
{% include visual-cta.html visual_id="V10" %}
...
A hybrid design can combine thin device interfaces, gel over magnetics, pads on local PCB devices, and selective potting.
