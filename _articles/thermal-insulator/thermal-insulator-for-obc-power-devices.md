---
title: "Thermal Insulator for OBC Power Devices"
description: "The insulator must provide required electrical isolation while keeping thermal impedance inside the device temperature budget."
...
<div class="quick"><strong>Quick answer</strong><p>Breakdown voltage is not the same as a qualified continuous working voltage.</p></div>
...
Filled films, coated phase-change films, elastomeric insulators, and ceramics trade conformity, strength, and thermal resistance.
...
Assess the complete fastener, flatness, edge, contamination, creepage, clearance, and thermal-cycle system.
