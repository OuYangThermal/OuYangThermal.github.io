---
title: "Thermal Potting Compound for OBC: How to Select It"
description: "Select OBC potting by thermal path, dielectric design, cured modulus, adhesion, cure, mass, process, and repairability."
...
<div class="quick"><strong>Quick answer</strong><p>Potting is a system-level commitment, not simply a high-conductivity filler.</p></div>
...
Potting can conduct heat and protect electronics, but a large cured mass can load components during thermal cycling and complicate service.
...
For a transformer, evaluate selective fill depth, voiding, exotherm, cured stress, and thermal performance on full-size hardware.
