---
title: "How to Select TIM for IGBT and MOSFET"
description: "Select by package-to-sink heat path, isolation need, flatness, mounting pressure, power cycling, and service process."
...
<div class="quick"><strong>Quick answer</strong><p>First establish whether electrical isolation is required and where it is provided.</p></div>
...
Discrete packages and baseplated modules differ in heat spreading and mounting. Grease, films, pads, and ceramics serve different constraints.
...
Measure case-to-sink performance with production fastener patterns and torque sequence.
