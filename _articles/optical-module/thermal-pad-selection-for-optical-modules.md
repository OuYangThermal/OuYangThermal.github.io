---
title: "Thermal Pad Selection for Optical Modules"
description: "Choose pads by compressed gap, low-force conformity, impedance, cleanliness, dimensional control, and cycling stability."
...
<div class="quick"><strong>Quick answer</strong><p>Highest conductivity may be unsuitable if assembly force is excessive.</p></div>
...
Pads can provide repeatable clean placement, but their compression curve must fit the module and cage envelope.
...
Build worst-case gap samples and measure temperature plus insertion and retention behavior.
