---
title: "How to Select Thermal Gel for Power Electronics"
description: "Select gel by gap, thermal budget, allowable stress, orientation, dispensing, electrical needs, and lifetime environment."
...
<div class="quick"><strong>Quick answer</strong><p>Installed thickness and void control matter as much as bulk conductivity.</p></div>
...
Power electronics combine heat, voltage, mass, vibration, and thermal expansion; the gel must maintain contact without harming clearances.
...
Use a designed bead pattern, compression stops, shot verification, cross-sections, power cycling, and vibration tests.
