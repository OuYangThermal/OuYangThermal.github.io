---
title: "What Is Thermal Gel?"
description: "Thermal gel is a dispensable, highly compliant gap filler that replaces insulating air between heat sources and cooling surfaces."
...
<div class="quick"><strong>Quick answer</strong><p>It is useful where tolerance or geometry makes a pre-cut pad difficult.</p></div>
...
Conductive fillers are dispersed in a polymer system. The material conforms around height variation while applying relatively low stress.
...
Uses include OBC magnetics, battery-to-plate gaps, converters, and complex server electronics.
