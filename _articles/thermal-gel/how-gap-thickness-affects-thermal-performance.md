---
title: "How Gap Thickness Affects Thermal Performance"
description: "For fixed material and area, a thicker gap generally increases bulk thermal resistance; contact and spreading determine the full result."
...
<div class="quick"><strong>Quick answer</strong><p>Reduce bond-line thickness where tolerances and mechanical limits permit.</p></div>
...
The ideal relation R = t/(kA) explains the thickness effect, but voids, squeeze, anisotropy, and contact modify it.
...
Test several controlled spacers in target geometry without extrapolating beyond qualified thickness.
