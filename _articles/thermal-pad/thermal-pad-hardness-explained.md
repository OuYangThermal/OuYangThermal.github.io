---
title: "Thermal Pad Hardness Explained"
description: "Pad hardness is a method-dependent indentation result; it does not directly predict assembly force or thermal performance."
...
<div class="quick"><strong>Quick answer</strong><p>Use supplier compression-deflection data for mechanical design.</p></div>
...
Shore 00 is often used for soft elastomers, but scale, thickness, dwell, and specimen preparation affect results.
...
A large low-hardness pad can still create high total force because force equals stress times area.
