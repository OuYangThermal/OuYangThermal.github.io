---
title: "Thermal Pad Thickness Selection Guide"
description: "Choose the thinnest pad that maintains contact across the tolerance stack without exceeding allowable force."
...
<div class="quick"><strong>Quick answer</strong><p>Thickness selection is a tolerance and mechanics problem before a catalog choice.</p></div>
...
Greater thickness usually adds bulk resistance but accommodates more variation. The optimum balances both.
...
Measure representative housings and populated boards, then build tolerance-corner samples.
